...
$c = Get-Content "C:\Users\lenovo\.openclaw\workspace\admin_v9.html" -Raw -Encoding UTF8
$base = [Convert]::ToBase64String([System.Text.Encoding]::UTF8.GetBytes($c))
$body = @{message="Update v9";content=$base;sha=$f.sha} | ConvertTo-Json
